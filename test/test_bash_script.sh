...
# steps:
#  - enter the subject folder and create a tmp folder for analysis
#  - copy the bvals & bvecs inside a temporary folder for the analysis
#  - copy the diffusion and anatomical into that folder
#  - 



for i in ~/Desktop/Covid_subjs/* ; do
    ...
    cp -a ~/Desktop/Triumph_Git/mddLong_experimental_params/.
    ...
    #flirt -in deobliqued.nii -ref skullatripped.nii  -out flirted.nii
    ...
    # flirt -ref t1_sag_3d_bravo.nii -in b0_nii_fromMat.nii -applyxfm -init out_epi_reg.mat -out b0_nii_froMat_epiregistered
